...
def predict_sensor():
    ...
    # Ensure the data point is in the correct order of columns
    data_point_df = data_point_df[sequence_cols]
    ...
    data_sequence = np.tile(data_point_df.values, (sequence_length, 1)).reshape(1, sequence_length, len(sequence_cols))
